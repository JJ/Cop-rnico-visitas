...
What we have found by looking at nine different pages corresponding to
9 different persons that have become trending topics in social
networks, but specially in Spain, starting with a very local event
that actually initiated this research. What we have found analyzing
visit data is that noteworthiness lasts for at least a week, and
...
events, that has focused on the duration and mid-term secondary
