...
Let us first look at the first chart on the left, representing visits of the Robert Vaughn page. 
...
meryl.cop.datos <- data.frame( dia=c(1:nrow(meryl.2017),1:nrow(datos.2017)),
                    ...
                    visits=c(meryl.2017$V1,datos.2017$V1))
ggplot(meryl.cop.datos,aes(x=dia,y=visits,group=year,col=year))+geom_line()+theme_tufte()
```
