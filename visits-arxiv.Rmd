...
90s, is the name attributed the increase in pageviews that the
...
[@blanco2009blog] originated by mentions the web Barrapunto.com, a
Spanish Slashdot. 

However and to the extent of our knowledge, until now there has not
been many studies analising a similar effect provoked by mentions in
...
topics that become in the social networks. However, the effect these
...
The rest of the paper is organised in the following way: next we present
the methodology that has been followed in order to capture and study
the data is presented. In the followint section the visits to the
