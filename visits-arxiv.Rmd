...
ggplot(ratio,aes(x=day,y=ratio))+geom_line()+scale_y_log10() + theme_tufte()
```

We plot the *y* axis in a logarithmic scale to see more clearly the ration after *relaxation*. 
