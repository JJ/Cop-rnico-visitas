...
```{r carrie,echo=FALSE,fig.width=4,fig.align='center'}
...
ggplot(george.datos,aes(x=dia,y=visits,group=year,col=year))+geom_line()+theme_tufte()
...
ggplot(vaughn.datos,aes(x=dia,y=visits,group=year,col=year))+geom_line()+theme_tufte()
